    ...
    <body id="miBody" style="<?php echo $theme; ?>">
        <div class="container" style="width:100%" >
            <div class="page-header">
                ...
                if ($objUser->perfil == "administrador" || $objUser->perfil == "usuario")
                {
                    echo "<a class='btn btn-primary animated bounceInLeft' href='#' onclick='CargarFormUsuario(4, ".$objUser->id.")'><span class='glyphicon glyphicon-user'></span>Editar Perfil&nbsp;</a>";
                }
                if ($objUser->perfil == "administrador")
                {
                    echo "<a class='btn btn-info animated bounceInLeft' href='#' onclick='CargarFormUsuario(3)'><span class='glyphicon glyphicon-user'>&nbsp;</span><span class='glyphicon glyphicon-plus-sign'></span>Agregar Usuario&nbsp;</a>";
                }
                ...
                <span id="spanDatos" class="animated bounceInRight" style='margin-top:-10px' ><h3>
                    <?php
                        //IMPLEMENTAR...OK
                        echo $objUser->nombre." - ".$objUser->perfil;
                    ?>&nbsp;&nbsp;</h3></span>
            </div>
